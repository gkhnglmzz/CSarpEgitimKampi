...
namespace _02_Variables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("-------- PortakalFiyatı :" + orangePrice + "TL");
            //Console.WriteLine("-------- Çilekim Fiyatı :" + strawberryPrice + "TL");
            ...
            //Console.WriteLine("Alınan Ürün : Patetes- " + "Birim Fiyat: " + potatoPrice + " - Gramaj : " + potatoGram + "- Toplam Tutar :" + potatoTotalPrice);
